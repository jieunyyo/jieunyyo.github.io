...
function AboutPage() {
  ...
  return (
    <AboutTemplate
      ...
      <BasicParagraph>
        수많은 밤을 지새웠습니다. 그럼에도 불구하고 멈추지 않았던 이유가 있습니다. 제가 본 웹사이트들은 디자인에 대해  더 많은 열정과 호기심을<br/>
        가질 수 있도록 동기부여를 해줬습니다. 새로운 것을 만들어내기 위해 몰두하고, 현실화 하는 과정은 늘 짜릿한 일이며 가장 믿을 수 없는 경험 중 하나입니다.<br/>
        <br/>
